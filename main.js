...
const getLocalDate = (date, isSeconds = false, isISO = false) => {
  const repSec = new RegExp(":\\d{2}$", "gui");
  ...
  if (isISO) {
    ...
    return isSeconds
      ...
      : date.toLocaleString().replaceAll("/", ".").replace(repSec, "");
  }
};

// console.log("+++++++"); // 16.07.2019, 00:15
